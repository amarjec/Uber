            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                <div className='w-full mt-5'>
                    ...
                    <div className='flex items-center gap-5 p-3'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>₹155.20 </h3>
                ...
                <div className='mt-10 w-full'>
                    ...
                    <Link to='/captain-home'
                        ...
                        <p className='text-red-500 tracking-tighter text-xs mt-6 ml-1 flex items-center'>Click on Finish Ride button, if payment is already completed.</p>
                </div>
            </div>
        </div>
    )
